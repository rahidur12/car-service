...
<head>
    ...
    {{-- ============================================================
         PRECONNECT: Warm up CDN connections before any requests fire
    ============================================================ --}}
    ...
    {{-- ============================================================
         CRITICAL CSS INLINE: Enough to paint navbar + page skeleton
         without any blocking network requests. Zero render-blocking.
    ============================================================ --}}
    <style>
        /* ── Minimal critical styles inlined to prevent FOUT & layout shift ── */
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav-btn-wrapper { margin-top: -8px; margin-bottom: -8px; }
    </style>

    {{-- ============================================================
         NON-BLOCKING CSS: All stylesheets loaded asynchronously.
         media="print" trick + onload swap = zero render blocking.
         Noscript tags ensure CSS still loads without JavaScript.
    ============================================================ --}}
    ...
    {{-- Google Analytics (async — never blocks rendering) --}}
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-0">
        <div class="container-fluid d-flex align-items-center justify-content-between px-4 px-lg-5">
            <!-- Logo — width + height attributes prevent CLS -->
            ...
            <!-- Mobile toggle (collapse-based, no offcanvas on service pages) -->
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="d-flex align-items-stretch nav-btn-wrapper">
                <a href="{{ route('contact') }}"
                   ...
                   style="background-color:#001d23;color:#fff;font-weight:bold;border:none;height:100%;">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-4">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3820.644202007923!2d55.2771888!3d25.2312177!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f438155692891%3A0x85f09a9921e1c24c!2sDubai%20Car%20Repair%20Service%20%7C%20Car%20Battery%20Change%20Dubai%20%7C%20Car%20Engine%20Service%20Dubai!5e1!3m2!1sen!2sbd!4v1779290540911!5m2!1sen!2sbd"
                            ...
                            title="Dubai Car Repair Service on Google Maps"></iframe>
                </div>
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="d-flex pt-2">
                        ...
                        <a class="btn btn-outline-light btn-social" href="https://www.pinterest.com/dubaicarrepairservice/" rel="noopener" aria-label="Pinterest"><i class="fab fa-pinterest-p"></i></a>
                    </div>
                </div>
    ...
    {{-- ============================================================
         ALL JS DEFERRED: Loads after HTML parsing completes.
         Removed duplicate owl carousel CDN (was loading twice).
    ============================================================ --}}
    ...
    <script>
        ...
        // Toastr notification on session flash
