                ...
                <div class="col-12 col-md-10 col-lg-7 text-center text-lg-start">
                    ...
                    <div class="row g-2 justify-content-center justify-content-lg-start mb-4" style="max-width: 540px; margin: 0 auto;">
                        <div class="col-6 col-sm-auto">
                            <a href="tel:0566121423" class="btn btn-primary rounded-pill w-100 px-3 py-2 fw-semibold shadow-sm" style="font-size: 0.88rem; white-space: nowrap;">
                                <i class="fa fa-phone-alt me-1"></i>Call 056 612 1423
                            </a>
                        </div>
                        <div class="col-6 col-sm-auto">
                            <a href="https://wa.me/971566121423" class="btn btn-success rounded-pill w-100 px-3 py-2 fw-semibold shadow-sm" style="font-size: 0.88rem; white-space: nowrap;">
                                <i class="fab fa-whatsapp me-1"></i>WhatsApp
                            </a>
                        </div>
                        <div class="col-12 col-sm-auto mt-2 mt-sm-0">
                            <a href="#booking" class="btn btn-outline-light rounded-pill w-100 px-3 py-2 fw-semibold" style="font-size: 0.88rem; white-space: nowrap;">
