        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <p style="color:#444;line-height:1.8;">
                    Car maintenance in Dubai operates on different rules from the schedules printed in your owner's manual. Planning annual car maintenance dubai drivers can rely on means taking environmental realities into account. Every manufacturer calculates recommended service intervals based on standard test conditions - typically 20°C ambient temperature, moderate highway driving, and clean air. Dubai's reality is 45°C sustained heat, sandstorm conditions, and engines that idle for extended periods in stop-and-go traffic on Sheikh Zayed Road while running air conditioning at maximum capacity.
                </p>
                <p style="color:#444;line-height:1.8;">
                    The consequence of following the manufacturer's printed schedule without adjustment is accelerated engine wear, premature battery failure, degraded brake fluid that boils under hard braking, clogged cabin filters that reduce AC performance, and coolant that loses its corrosion protection before its stated change interval. When you schedule service with us, every car periodic maintenance service plan we carry out is adapted for UAE driving conditions. Whether booking a routine scheduled service or a complete annual car service dubai package, we adjust every schedule with shortened oil change intervals, more frequent filter replacements, and annual battery and cooling system checks regardless of mileage.
                </p>
                <p style="color:#444;line-height:1.8;">
                    Our workshop at 222 Al Satwa Road handles scheduled servicing for all makes and models - from a simple oil and filter change to a full major service covering every wear item on the vehicle. For reliable recurring car care dubai motorists trust, <a href="{{ route('home') }}" class="text-primary fw-semibold text-decoration-none">Dubai Car Repair Service</a> uses genuine parts, provides a written record of everything replaced, and gives you a condition report on items approaching their service limit so you can plan ahead.
                </p>
            </div>
            <div class="col-lg-6">
...
<div class="container-fluid py-5 bg-light wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="row g-4">
            @php $reasons = [
                ['fa-thermometer-half', 'UAE-Adapted Service Schedules',      '12 years of servicing cars in Dubai has taught us where the standard car service schedule is insufficient for UAE conditions. We adjust intervals and inspection priorities based on what actually fails in this climate.'],
                ['fa-award',            'Genuine Parts, Every Time',           'Whether you previously opted for car service dubai al quoz facilities or dealership network repairs, we ensure no substituted fluids and no grey-market filters. Every part we fit meets or exceeds OEM specification. We list every part replaced on your service record so there is a documented history if you sell the vehicle.'],
                ['fa-file-alt',         'Full Written Service Record',         'After every service, you receive a printed record detailing the total car service dubai price factors, including everything inspected, checked, and replaced - as well as the brand and grade of oil used. This is not a formality; it is your asset when you sell the car.'],
                ['fa-search',           'Condition Report on All Items',        'If you are searching for a car service dubai near me, our workshop goes beyond what we replace. We document the condition of every other item we inspect - so you know what is approaching its service limit and can plan your budget before it becomes an emergency.'],
                ['fa-car',              'All Makes, One Workshop',             'Whether traveling from Downtown or commuting near the car service dubai airport area, we carry genuine-equivalent parts and the correct fluids for Japanese, European, American, and Korean vehicles. One workshop, consistent standards, regardless of what you drive.'],
                ['fa-receipt',          'No Package Upselling',                'We recommend the service package your vehicle actually needs at that mileage and condition - avoiding unnecessary car repair dubai costs. If a major service component was done recently, we skip it and show you why.'],
            ]; @endphp
                ...
                <div class="accordion" id="maintFaq">
                    @php $faqs = [
                        [
                            ...
                            'In Dubai\'s climate, managing your overall car maintenance dubai cost requires setting appropriate intervals. We recommend a basic oil and filter service every 5,000–7,500 km for synthetic oil users, or every 4,000–5,000 km for mineral oil. A full service covering filters, brakes, and fluid checks should be done every 15,000 km or every 6 months - whichever comes first. A major service covering all wear items annually or every 30,000 km. These intervals are shorter than manufacturer recommendations to account for Dubai\'s extreme heat and stop-and-go traffic.',
                        ],
                        [
                            'What is included in a full car service in Dubai?',
                            'While mobile car maintenance dubai options cover lightweight tasks on-site, our workshop full service covers: engine oil and filter replacement, engine and cabin air filter replacement, brake pad measurement (all four corners), brake disc condition check, brake fluid boiling point test, battery load test, OBD-II diagnostic scan, coolant concentration test, tyre tread depth and DOT age check, drive belt inspection, and a full underbody visual inspection on our ramp. You receive a written report of everything checked and its condition.',
                        ],
                        [
                            'Does a car service void my warranty in Dubai?',
                            'No. To receive the best car maintenance dubai vehicle owners expect, you do not need to stay restricted to dealership centers. Under UAE consumer protection rules and international block exemption regulations, having your car serviced at an independent workshop does not void your manufacturer\'s warranty - provided the workshop uses the correct specification parts and fluids, and maintains a written service record. We document every service with the correct oil grade, filter brand, and service date - exactly as a dealer would.',
                        ],
                        [
                            'How long does a car service take in Dubai?',
                            'Drivers seeking cheap car maintenance dubai solutions often worry about long turnaround delays, but we keep our workflow streamlined. A basic oil and filter service takes 30–45 minutes. A full service covering all inspection items takes 1.5–2.5 hours. A major service takes 3–5 hours depending on what replacement items are required. We give you a realistic time estimate when you drop the car off - not an optimistic one.',
                        ],
                        [
                            'What is the difference between a full service and a major service?',
                            'A full service focuses on the fluid and filter items that degrade most rapidly - oil, air filters, brake fluid check, battery test, and a visual inspection of wear items. When comparing services like german experts car maintenance dubai benchmarks, a major service goes further: it replaces spark plugs, fully flushes all fluid systems (coolant, brake fluid, gearbox where due), performs a 4-wheel alignment check, and covers every item on the manufacturer\'s scheduled maintenance list. Think of a major service as a complete reset of consumables.',
                        ],
                        [
                            'Can you service my car even if I don\'t know the service history?',
                            'Yes - this is very common with used cars purchased in Dubai. As seen in german experts car maintenance dubai reviews, proper physical inspections outweigh missing paperwork. As trusted car experts auto services providers, we perform a full inspection before deciding what the car needs, based on actual component condition. We check the oil condition, brake fluid boiling point, spark plug wear, battery age, tyre DOT code, and any stored fault codes. This gives us an honest picture of the car\'s real maintenance state regardless of what the service book says.',
                        ],
                    ]; @endphp
