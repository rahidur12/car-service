    ...
    <div class="container">
        <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <p style="color:#444;line-height:1.8;">
                        RTA vehicle registration renewal in Dubai requires passing a official car inspection dubai rta compliant roadworthiness test at an authorised test centre - including Tasjeel, Wasel, and Emirates Vehicle Gate. Vehicles older than 3 years from registration must pass this test annually. Failing the test requires immediate repairs and a return visit, adding cost and time.
                    </p>
                    <p style="color:#444;line-height:1.8;">
                        Our pre-RTA vehicle inspection dubai checklist replicates the actual test criteria used at Dubai test centres - checking the exact items that cause failures. Common RTA failure reasons we fix before you arrive:
                    </p>
                </div>
                @php $rtaFails = [
