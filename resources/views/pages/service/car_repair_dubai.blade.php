        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <p style="color:#444;line-height:1.8;">
                    Car repair in Dubai is a service where the quality of the diagnosis determines the quality of the repair. Whether evaluating the overall car repair dubai price or selecting a dedicated car workshop dubai drivers trust, understanding local driving demands is vital. Dubai's driving environment - sustained 45°C ambient temperatures, high-speed highway use, and heavy stop-and-go traffic on Sheikh Zayed Road and Al Khail Road - creates specific auto repair dubai failure patterns that a one-size-fits-all approach misses. Cooling systems work at capacity for months at a time. Engine oils degrade in half the distance. Rubber seals and gaskets age in UAE heat at twice the rate of temperate climates.
                </p>
                <p style="color:#444;line-height:1.8;">
                    At <a href="{{ route('home') }}" class="text-primary fw-semibold text-decoration-none">Dubai Car Repair Service</a>, every repair guided by an experienced car mechanic dubai team begins with a full OBD-II diagnostic scan and a physical inspection - before any parts are quoted, ordered, or removed. When booking a complete car service dubai package, we identify exactly what is causing the fault, explain it clearly, and give you a written itemised quote covering parts and labour. Work only begins after your confirmation. The price on your quote is the price on your invoice - not a starting point for additions.
                </p>
                <p style="color:#444;line-height:1.8;">
                    From our central workshop at 222 Al Satwa Road, our team of 8 certified mechanics has been servicing all car makes across Dubai since 2012 - Japanese, European, American, Korean, and British platforms. Whether you need car repair dubailand drivers rely on, require car repair dubai silicon oasis mobile assistance, or are searching for car repair dubai near me, our reach extends across the city. Over 8,500 customers across Jumeirah, Business Bay, Al Quoz - including motorists who previously sought car repair dubai al quoz services - Al Barsha, Karama, and DIFC have trusted us to tell them the truth and fix it right the first time.
                </p>
            </div>
            <div class="col-lg-6">
...
<div class="container-fluid py-5 bg-light wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="row g-4">
            @php $reasons = [
                ['fa-map-marker-alt', 'Centrally Located in Al Satwa',         '222 Al Satwa Road is minutes from Sheikh Zayed Road, Jumeirah, Bur Dubai, Karama, Downtown Dubai, and DIFC - offering the cheapest car repair dubai value without sacrificing quality at one of the most accessible workshop locations in the city. Free parking outside.'],
                ['fa-search',         'Diagnostic-First, Always',               'We deliver the best car repair dubai motorists can choose by never recommending a replacement before confirming it is the cause. This prevents the most expensive mistake in car repair: replacing parts that were not at fault and missing the real problem.'],
                ['fa-award',          'Genuine Parts, Correct Specification',   'Oil grades, brake pads, filters, and engine parts for standard vehicles and mobile car repair dubai setups are chosen to manufacturer specification - not substituted with cheaper alternatives that degrade faster in Dubai\'s heat.'],
                ['fa-user-check',     '12 Years, Same Mechanics',               'Our team has continuity across conventional combustion engines and modern e car repair dubai systems. The mechanics who worked on cars in 2012 are still here. That institutional knowledge - particularly across Japanese and European platforms in the UAE - cannot be replicated by high-turnover operations.'],
                ['fa-receipt',        'No Surprises on the Invoice',            'As true car experts auto services providers, the quote is the invoice. If additional faults are discovered during the repair, we call you and explain before doing anything. You always control what gets approved.'],
                ['fa-star',           '4.8★ Rating from Real Customers',        'Our Google reviews for car experts dubai services come from real Dubai drivers - not templates. Read them and you will find the same phrases repeated: honest, fast, fair price, explained everything clearly. That is the standard we maintain.'],
            ]; @endphp
