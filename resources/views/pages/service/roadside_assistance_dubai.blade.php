        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <p style="color:#444;line-height:1.8;">
                    Reliable roadside assistance dubai drivers can rely on is needed most often for three reasons - and none of them give you advance warning. Having access to a fast road assistance service becomes vital when facing a dead battery that appeared healthy this morning, a tyre blowout caused by a sidewall that had been hardening invisibly for three years in UAE heat, or an overheating engine that ran fine on the morning commute and stopped on the way home.
                </p>
                <p style="color:#444;line-height:1.8;">
                    <a href="{{ route('home') }}" class="text-primary fw-semibold text-decoration-none">Dubai Car Repair Service</a> mobile mechanics deliver dependable road assistance dubai motorists trust across all areas during operating hours - 7AM to 10PM, Saturday to Friday. When you request roadside assistance and call <strong>+971 56 612 1423</strong>, you speak to our team directly. We confirm your location, identify the likely cause from your description, and dispatch a certified mechanic in a fully equipped road assistance car - not an untrained driver with a jump pack.
                </p>
                <p style="color:#444;line-height:1.8;">
                    Our team providing road side assistance dubai vehicle owners count on carries the tools and stock to resolve the most common breakdown causes on the spot - dead batteries, flat tyres, fuel issues, and minor electrical faults - without requiring a tow. For complex mechanical issues that require roadside assistance in dubai to be backed up by full workshop attention, we arrange towing to our <strong>222 Al Satwa Road workshop</strong> and prioritise your vehicle.
                </p>
            </div>
            <div class="col-lg-6">
...
<div class="container-fluid py-5 bg-light wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="row g-4">
            @php $reasons = [
                ['fa-user-check',   'Certified Mechanics - Not Tow Drivers',   'Our dubai roadside assistance responders are the same certified mechanics who work at our Al Satwa workshop. They diagnose the fault correctly at the roadside - not just jump-start you and leave.'],
                ['fa-search',       'Diagnosis on the Spot',                   'Whether you are searching for roadside assistance near me or stranded on a busy highway, we carry professional OBD-II diagnostic equipment on every callout. A warning light that caused your breakdown is read and explained at your location - before any decision about towing is made.'],
                ['fa-battery-full', 'Battery Stock in the Van',                'When you need emergency car help for a dead battery, we carry the most common battery sizes and types for Dubai vehicles - including AGM units - so if your battery fails the load test, you don\'t need a second visit or a tow.'],
                ['fa-tools',        'Proper Tools, Not Just Jump Leads',        'Our mobile vehicle carries specialized equipment for porsche roadside assistance dubai drivers require, as well as tooling tailored for bmw roadside assistance dubai owners expect. With puncture repair tools, tyre levers, torque wrenches, and electrical testers, we resolve most breakdowns on the spot.'],
                ['fa-receipt',      'Price Confirmed Before We Start',          'Call-out fee for roadside recovery dubai services is confirmed when you book. Any parts or additional labour quoted before work begins. No surprise invoice when we arrive.'],
                ['fa-map-marker-alt','Central Base - Fast Coverage',            'Understanding roadside assistance dubai meaning speed and efficiency, our Al Satwa base positions us within 30 minutes of most Dubai locations. We know Dubai\'s roads well enough to avoid the routes that will slow us down during peak hours.'],
            ]; @endphp
                ...
                <div class="accordion" id="roadsideFaq">
                    @php $faqs = [
                        [
                            ...
                            'Move your car to the hard shoulder or emergency lane as quickly and safely as possible. Switch on your hazard lights immediately. If dealing with a roadside assistance dubai flat tyre emergency, stay inside with your seatbelt on until you can safely exit away from traffic. Do not stand behind the vehicle or in the traffic lanes. Once in a safe position, dial the roadside assistance dubai number at +971 56 612 1423. Give us the nearest road marker number or exit number - they are posted on green signs along SZR. We dispatch immediately and update you on arrival time.',
                        ],
                        [
                            'How long does roadside assistance take to arrive in Dubai?',
                            'Providing the best roadside assistance dubai drivers can experience means arriving promptly. From our Al Satwa base, we typically reach central Dubai areas - Jumeirah, Karama, Business Bay, Downtown Dubai, DIFC - within 15–35 minutes. Dubai Marina and Al Barsha are 30–50 minutes. Outer areas including Mirdif, Al Nahda, International City, and Dubai Silicon Oasis are 40–65 minutes. Peak hour traffic on Sheikh Zayed Road between 7:30–9:30 AM and 5:00–8:00 PM may add 10–20 minutes.',
                        ],
                        [
                            'Can you fix my car at the roadside or will I need towing?',
                            'For the most common breakdown causes - dead battery, flat tyre, fuel exhaustion, minor overheating from low coolant, and minor electrical faults - yes, we resolve the issue at your location without towing. Call our roadside assistance dubai contact number to describe your issue. For serious engine failure, major overheating damage, transmission fault, significant accident damage, or suspension collapse, towing to our Al Satwa workshop is required. We assess the fault at the roadside and give you an honest assessment before any costs are incurred.',
                        ],
                        [
                            'Do you provide roadside assistance 24 hours in Dubai?',
                            'Our roadside assistance operates from 7:00 AM to 10:00 PM, Saturday to Friday - every day of the week including weekends and UAE public holidays. While some insurance policies promise free roadside assistance dubai add-ons with overnight call centres, we operate direct mechanic dispatch during our primary operating hours. For breakdowns outside these hours, we recommend RTA\'s breakdown service or your car insurance company\'s roadside assistance as 24-hour alternatives. When we open at 7AM, call us immediately and we prioritise any overnight breakdown cases.',
                        ],
                        [
