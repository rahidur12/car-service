    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                ...
                <p style="color:#444;line-height:1.8;">
                    <a href="{{ route('home') }}" class="text-primary fw-semibold text-decoration-none">Dubai Car Repair Service</a> mobile mechanics are certified technicians - the same team that works from our 222 Al Satwa Road workshop - dispatched in fully equipped service vehicles carrying the diagnostic tools, common replacement parts, and fluids needed to resolve the most frequent car problems on the spot. Whether you need a mobile car mechanic dubai drivers trust or are searching for mobile car repair near me, our mobile mechanic dubai units respond quickly. A qualified mobile car mechanic handles tasks from a dead battery or an AC system that stopped cooling, to an overdue oil change, a brake warning light, or a minor electrical fault. A dedicated mobile mechanic can diagnose and resolve these issues at your home, office, apartment building, car park, or roadside location anywhere in Dubai.
                </p>
                <p style="color:#444;line-height:1.8;">
                    What our service is not: a junior technician with a basic toolkit. Every driver looking for a mobile mechanic near me gets an experienced, certified mechanic who knows when a job is within the scope of mobile service and - critically - when the vehicle needs to come to the workshop. That honest assessment is part of the service.
                </p>
            </div>
            <div class="col-lg-6">
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="row g-4">
            @php $reasons = [
                ['fa-user-check',     'Certified Mechanics - Not Freelancers',  'Our team delivering mobile car repair service solutions are the same certified mechanics who work at our Al Satwa workshop. Not agency-sourced freelancers, not apprentices. Trained, experienced, and accountable to our workshop\'s standards.'],
                ['fa-search',         'Proper Diagnosis at Your Location',      'When booking a mobile car service dubai motorists rely on, we carry professional OBD-II diagnostic equipment on every dispatch. We never guess at a fault or replace parts speculatively. If we cannot diagnose it correctly at your location, we tell you.'],
                ['fa-award',          'Genuine Parts in the Van',               'For every mobile car repair dispatch, we carry Exide and Bosch batteries, branded oil in the correct grades, and OEM-quality filters in our mobile vehicle. You receive the same parts quality as a workshop visit.'],
                ['fa-receipt',        'Price Agreed Before Work Starts',         'Drivers looking for a mobile auto mechanic near me appreciate our upfront policy. The call-out fee is confirmed when you book. The parts and labour price is confirmed after on-site diagnosis. No surprise charges when we arrive, and nothing added without your approval.'],
                ['fa-shield-alt',     'Workshop Backup for Complex Repairs',     'If your fault requires workshop-level equipment, our mobile garage dubai team arranges transport to our Al Satwa garage and prioritises your vehicle. Mobile service is a convenience extension of our full workshop - not a substitute.'],
                ['fa-map-marker-alt', 'All Dubai Areas, Same Day',               'If you need a mobile car mechanic near me, we cover all of Dubai from our central Al Satwa base. Most locations within 30–60 minutes. Operate 7AM to 10PM every day - including weekends and UAE public holidays.'],
            ]; @endphp
        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="accordion" id="mobileFaq">
                    @php $faqs = [
                        ['How quickly can a mobile mechanic reach me in Dubai?','When you request an auto mobile mechanic, speed matters. As the best mobile car mechanic dubai team available, we dispatch directly from our Al Satwa base. We typically reach central Dubai areas - Jumeirah, Karama, Business Bay, Downtown, DIFC - within 20–40 minutes. Outer areas like Dubai Marina, Al Barsha, and JVC take 35–55 minutes. Mirdif, Al Nahda, and International City are 40–60 minutes. These estimates are subject to traffic conditions, particularly on Sheikh Zayed Road during peak hours.'],
                        ['What is the call-out fee for mobile car repair in Dubai?','Our mobile call-out fee is AED 30, making us a top choice for the best mobile car repair dubai drivers depend on. Even for those searching for the cheapest mobile car repair dubai options, this fee covers the mechanic\'s travel to your location and is added to the service price. There is no minimum charge beyond this - if the issue is a simple battery test that shows the battery is fine and only needs charging, you pay the diagnostic fee and the call-out fee. No upselling, no inflated minimums.'],
                        ['Can a mobile mechanic fix my car AC in Dubai?','For a simple refrigerant recharge (gas refill), yes - our mobile car ac repair dubai service carries R134a and R1234yf refrigerant in our mobile vehicle and can recharge at your location. However, if there is a refrigerant leak, compressor failure, or condenser blockage, proper mobile car diagnostics or workshop assistance is required at our Al Satwa workshop where we have leak detection equipment, vacuum pumps, and calibrated recharge stations.'],
                        ['What information do I need to give when I call for mobile repair?','Your location (building name, street, and area), your car make, model, and year, and a description of the problem or symptom. Whether you need roadside mobile car tyre repair dubai support or minor bodywork assessment like mobile car scratch repair dubai, tell us if there is a specific warning light on the dashboard. This allows us to bring the most likely parts needed and confirm in advance whether the repair is within mobile scope.'],
                        ['Is mobile car repair more expensive than going to a workshop?','The price for parts and labour with our mobile car repair service dubai options matches our workshop rates. Unlike combining a basic mobile car wash service dubai with separate maintenance, our unified dispatch saves time. The only additional cost is the AED 30 call-out fee. For many customers - particularly those paying for parking or towing to a garage - the mobile service is cost-neutral or cheaper once those costs are considered. For battery replacements alone, avoiding a tow truck typically saves AED 150–300.'],
                        ['Can you repair my car in a covered parking garage?','Yes - operating as a fully functional mobile car workshop dubai service, we perform work as long as there is adequate ventilation. Battery replacements, oil changes, filter replacements, and diagnostic scans can all be performed in covered car parks. We cannot perform work in enclosed basement parking with no airflow where fumes or oil vapour could accumulate. We assess the location when we arrive and advise accordingly.'],
                    ]; @endphp
